...
def about_us(request):
    ...
    return render(request, template_name,
                  {'homeinfo': homeinfo, "language_code": language_code, 'home_background': home_background})
...
def show_dr_details(request, pk):
    ...
    return render(request, template_name,
                  {"doctor": doctor, "language_code": language_code, 'home_background': home_background})
...
def show_work_details(request, pk):
    ...
    return render(request, template_name,
                  {"work": work, "language_code": language_code, 'home_background': home_background})
...
def contacts_page(request):
    ...
    return render(request, template_name,
                  {"usersdata": usersdata, "language_code": language_code, 'home_background': home_background})
...
def dr_page(request):
    ...
    doctors = AddDr.objects.all()
    return render(request, template_name,
                  {"doctors": doctors, "language_code": language_code, 'home_background': home_background})
...
def add_dr(request):
    ...
    if request.user.is_superuser or request.user.is_admin:
        ...
        if request.method == 'POST':
            ...
            d = AddDr.objects.create(admin=request.user, name=name, job=job, time=time, image=image,
                                     description=description,
                                     name_ar_field=name_ar_field, job_ar_field=job_ar_field,
                                     time_ar_field=time_ar_field, description_ar_field=description_ar_field
                                     )
...
def edit_dr(request, pk):
    ...
    if request.user.is_staff or request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            form = AddDrForm(instance=drtable)
            return render(request, template_name,
                          {'form': form, 'home_background': home_background, "language_code": language_code})
...
def work_page(request):
    ...
    return render(request, template_name,
                  {"works": works, "language_code": language_code, 'home_background': home_background})
...
def add_work(request):
    ...
    if request.user.is_admin or request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            d = AddWork.objects.create(dr=dr_instance, dr_ar_field=dr_instance, title=title, category=category,
                                       image=image, description=description,
                                       title_ar_field=title_ar_field, category_ar_field=category_ar_field,
                                       description_ar_field=description_ar_field
                                       )
